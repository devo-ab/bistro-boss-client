      ...
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl flex-1">
        ...
        <form onSubmit={handleSignIn} className="space-y-6">
          ...
          <button
            disabled={disabled}
            type="submit"
            className="btn bg-primary block w-full p-3 text-center rounded-sm"
          >
            Sign in
          </button>
        </form>
        ...
        <div className="flex justify-center space-x-4">
          <button onClick={handleGoogleSignIn} aria-label="Log in with Google" className="p-3 btn rounded-full">
            <svg
          ...
          <button aria-label="Log in with Twitter" className="p-3 rounded-full btn">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              className="w-5 h-5 fill-current"
          ...
          <button aria-label="Log in with GitHub" className="p-3 rounded-full btn">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              className="w-5 h-5 fill-current"
        ...
        <p className="text-xs text-center sm:px-6">
          ...
          <Link to="/signup"><button  className="underline">
            Sign up
          </button></Link>
        </p>
      </div>
